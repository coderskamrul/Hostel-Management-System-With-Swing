...
public class AllStudentLiving extends javax.swing.JFrame {
    ...
    public AllStudentLiving() {
       ...
       // jTable1.setAutoResizeMode(jTable1.AUTO_RESIZE_OFF);
        ...
        ResultSet rs = (ResultSet) st.executeQuery("Select*from student where status='living'");
        while(rs.next())
        {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nmae", "Father Name", "Mother Name", "Mobile", "Email", "Address", "Collage Name", "Id Number", "Room Number"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 79, 780, 510));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Algerian", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Students Living List");
